...
By default, a basic dataset will be returned and with each request and zero or more additional fields can be retrieved. To access this API, craft a resource URL pointing to the battle of an account whos information is to be retrieved.

```plain
URL = Host + "/api/d3/account/" + BattletagName + "-" + BattletagNumber
Battletag = BattletagName + "#" + BattleTagNumber
```
